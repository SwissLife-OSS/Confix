...
[1;93m![22;39m The local variable file was not found at the expected location. Created empty file at: '/Users/pascalsenn/kot/Confix-Reloaded/examples/GettingStarted/src/Website/variables.prod.json'
