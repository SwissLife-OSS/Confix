...
This guide will shouw you some options how you can do this, but after all, do it the way it fits your devops process.
...
e.g.
// build app & build config & publish -> Deploy to dev -> Deploy to prod
